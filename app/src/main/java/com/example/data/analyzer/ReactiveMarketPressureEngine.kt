...
object ReactiveMarketPressureEngine {
    ...
    fun buildTradingAnalysis(
        ...
        // SAFELY ADDED: Calculate micro-movement prediction using history
        val microPrediction = MicroPullbackDetector.detectMicroPullback(
            prev5m = prev5m,
            prev60m = prev60m,
            curr5m = valid5m,
            curr60m = valid60m,
            primaryDirection = finalResolvedDirection
        )
        ...
        return TradingAnalysis(
            ...
            microMovementPrediction = microPrediction // SAFELY ADDED: Micro-movement prediction
        )
    }
}
