...
data class TradingAnalysis(
    ...
    // SAFELY ADDED: Micro-movement prediction for pullback detection (non-breaking change)
    val microMovementPrediction: com.example.data.models.MicroMovementPrediction = com.example.data.models.MicroMovementPrediction.NO_PREDICTION
) {
